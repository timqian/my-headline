...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("/home/tim/javascript/my-headline/node_modules/react-hot-api/modules/index.js"), RootInstanceProvider = require("/home/tim/javascript/my-headline/node_modules/react-hot-loader/RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/home/tim/javascript/my-headline/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "index.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _config = __webpack_require__(355);

	var _Header = __webpack_require__(356);

	var _Header2 = _interopRequireDefault(_Header);

	var _Boxes = __webpack_require__(361);
	...
	var Container = function (_React$Component) {
	  ...
	  (0, _createClass3.default)(Container, [{
	    key: 'fetchLinksObj',
	    value: function fetchLinksObj(date) {
	      var _this2 = this;

	      return _axios2.default.get(_config.dataUrl + '/' + date + '.json', { timeout: 7000 }).then(function (res) {
	        _this2.setState({ linksObj: res.data });
	      }) //TO understand promise??? why this is this ???
	      .catch(function (err) {
	        throw err;
	      });
	    }
	    ...
	    key: 'handleAddDay',
	    value: function handleAddDay() {
	      var _this3 = this;

	      var newDate = (0, _moment2.default)(this.state.date).add(1, 'days').format('YYYY-MM-DD');
	      this.fetchLinksObj(newDate).then(function () {
	        _this3.setState({ date: newDate });
	    ...
	    key: 'handleSubtractDay',
	    value: function handleSubtractDay() {
	      var _this4 = this;

	      var newDate = (0, _moment2.default)(this.state.date).subtract(1, 'days').format('YYYY-MM-DD');
	      this.fetchLinksObj(newDate).then(function () {
	        _this4.setState({ date: newDate });
	        location.hash = newDate;
	      }).catch(function (err) {
	    ...
	    value: function componentDidMount() {
	      this.fetchLinksObj(this.state.date).catch(function (err) {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_Boxes2.default, { linksObj: this.state.linksObj })
	      );
	    }
	  }]);
	  return Container;
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.S + $export.F * !__webpack_require__(176), 'Object', {defineProperty: __webpack_require__(172).f});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(211)('iterator');
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(171)(IteratorPrototype, __webpack_require__(211)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global        = __webpack_require__(164)
	  , hide          = __webpack_require__(171)
	  , Iterators     = __webpack_require__(196)
	  , TO_STRING_TAG = __webpack_require__(211)('toStringTag');
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(169)(Function.call, __webpack_require__(227).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var defaults = __webpack_require__(339);
	var utils = __webpack_require__(340);
	var dispatchRequest = __webpack_require__(341);
	  ...
	  return new Promise(function executor(resolve, reject) {
	    try {
	      ...
	      if (typeof config.adapter === 'function') {
	        ...
	        adapter = __webpack_require__(343);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var btoa = window.btoa || __webpack_require__(348);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dataUrl = exports.dataUrl = 'https://raw.githubusercontent.com/timqian/my-headline-crawler/master/data';
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Header(_ref) {
	  var date = _ref.date;
	  var handleAddDay = _ref.handleAddDay;
	  var handleSubtractDay = _ref.handleSubtractDay;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".style__header___2uitE {\n  text-align: center;\n  color: #fff;\n  font-size: 1.3em; \n  background-color: rgba(45, 188, 61, 0.78);\n  padding:.7em;\n  margin-bottom: .7em;\n}\n", "", {"version":3,"sources":["/./components/Header/style.css"],"names":[],"mappings":"AAAA;EACE,mBAAmB;EACnB,YAAY;EACZ,iBAAiB;EACjB,0CAA0C;EAC1C,aAAa;EACb,oBAAoB;CACrB","file":"style.css","sourcesContent":[".header {\n  text-align: center;\n  color: #fff;\n  font-size: 1.3em; \n  background-color: rgba(45, 188, 61, 0.78);\n  padding:.7em;\n  margin-bottom: .7em;\n}\n"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Box = __webpack_require__(365);
	...
	function Boxes(_ref) {
	  var linksObj = _ref.linksObj;

	  var boxArr = (0, _keys2.default)(linksObj).map(function (site) {
	    return _react2.default.createElement(_Box2.default, { site: site, links: linksObj[site] });
	  });

	  return _react2.default.createElement(
	    'div',
	    { className: _style2.default.boxes },
	    boxArr
	  );
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Box(_ref) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      'div',
	      { className: _style2.default.site },
	      site
	    ),
	    links.map(function (link) {
	      return _react2.default.createElement(
	        'a',
	        { className: _style2.default.link, href: link.url },
	        ' ',
	        link.title,
	        ' '
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n.style__box___2Rpbl {\n  display: inline-block;\n  vertical-align: top;\n  max-width: 400px;\n  margin: .7em;\n  background: #fff;\n  // border-top: solid 4px rgba(45, 188, 61, 0.78);\n}\n\n.style__site___31aKW {\n  text-align: center;\n}\n\n.style__link___3Baap {\n  color: #4e4e4e;\n  display: block;\n  padding: .5em;\n  border-top: solid .4em #e2e2e2;\n}\n\n.style__link___3Baap:link, .style__link___3Baap:visited, .style__link___3Baap:active {\n  text-decoration: none;\n}\n\n.style__link___3Baap:hover {\n  text-decoration: underline;\n}\n", "", {"version":3,"sources":["/./components/Box/style.css"],"names":[],"mappings":";AACA;EACE,sBAAsB;EACtB,oBAAoB;EACpB,iBAAiB;EACjB,aAAa;EACb,iBAAiB;EACjB,iDAAiD;CAClD;;AAED;EACE,mBAAmB;CACpB;;AAED;EACE,eAAe;EACf,eAAe;EACf,cAAc;EACd,+BAA+B;CAChC;;AAED;EACE,sBAAsB;CACvB;;AAED;EACE,2BAA2B;CAC5B","file":"style.css","sourcesContent":["\n.box {\n  display: inline-block;\n  vertical-align: top;\n  max-width: 400px;\n  margin: .7em;\n  background: #fff;\n  // border-top: solid 4px rgba(45, 188, 61, 0.78);\n}\n\n.site {\n  text-align: center;\n}\n\n.link {\n  color: #4e4e4e;\n  display: block;\n  padding: .5em;\n  border-top: solid .4em #e2e2e2;\n}\n\n.link:link, .link:visited, .link:active {\n  text-decoration: none;\n}\n\n.link:hover {\n  text-decoration: underline;\n}\n"],"sourceRoot":"webpack://"}]);

	// exports
	exports.locals = {
		"box": "style__box___2Rpbl",
		"site": "style__site___31aKW",
		"link": "style__link___3Baap"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".style__boxes___37sUI {\n  margin: auto;\n}\n", "", {"version":3,"sources":["/./containers/Boxes/style.css"],"names":[],"mappings":"AAAA;EACE,aAAa;CACd","file":"style.css","sourcesContent":[".boxes {\n  margin: auto;\n}\n"],"sourceRoot":"webpack://"}]);

	// exports
	exports.locals = {
		"boxes": "style__boxes___37sUI"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "html,\nbody {\n  margin: 0;\n  padding: 0;\n}\n\nbody {\n  font: normal 100% Helvetica, Arial, sans-serif;\n  background: #e5e5e5;\n}\n\n\n\n", "", {"version":3,"sources":["/./containers/App/style.css"],"names":[],"mappings":"AAAA;;EAEE,UAAU;EACV,WAAW;CACZ;;AAED;EACE,+CAA+C;EAC/C,oBAAoB;CACrB","file":"style.css","sourcesContent":["html,\nbody {\n  margin: 0;\n  padding: 0;\n}\n\nbody {\n  font: normal 100% Helvetica, Arial, sans-serif;\n  background: #e5e5e5;\n}\n\n\n\n"],"sourceRoot":"webpack://"}]);
